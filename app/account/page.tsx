...
export default function AccountPage() {
  ...
  useEffect(() => {
    async function loadAccount() {
      ...
      // Orders belong to the authenticated customer row. Use the auth user id
      // directly so order history does not depend on a phone-number match.
  ...
  return (
    <main className="min-h-screen bg-[#f7f9fc] pb-16 text-slate-900">
      ...
      {[
        ["Orders", "View your orders", "/account/orders"],
        ["Wishlist", "Saved products", "/wishlist"],
        ["Help & Support", "Get assistance", "/help"],
        ["Shipping Info", "Delivery information", "/shipping"],
        ["Policies", "Returns & store policies", "/policies"],
        ["About", "About Model Town Garments", "/about"],
        ...
        >
          <p className="text-sm font-black text-slate-900 transition group-hover:text-[#102a56]">
            {title}
          </p>
          <p className="mt-1 text-xs leading-5 text-slate-500">
            {subtitle}
