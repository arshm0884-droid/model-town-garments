...
export default function Store() {
  ...
  useEffect(() => {
    try {
      const saved = localStorage.getItem("model-town-wishlist");
              ...
              >
                ...
                <div className="relative aspect-[4/5] overflow-hidden bg-[#eef2f7]">
                  <button
                    ...
                    className="absolute right-4 bottom-4 z-10 flex h-11 w-11 items-center justify-center rounded-full bg-white text-xl shadow-lg transition hover:scale-110"
                  >
